...
public class SwaggerConfiguration {
	...
	/*
	 * @Bean public Docket api() { // http://localhost:8090/swagger-ui.html
	 * return new Docket(DocumentationType.SWAGGER_2).select()
	 * .apis(RequestHandlerSelectors.basePackage(
	 * "com.jfeesoft.bplatform.controller"))
	...
	// @Value("${host.full.dns.auth.link}")infoBuildName
	...
	private OAuth securitySchema() {
		...
		GrantType creGrant = new ResourceOwnerPasswordCredentialsGrant("http://localhost:8090/oauth/token");
